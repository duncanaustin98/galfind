...
from galfind import GALFIND_Catalogue_Creator, Catalogue, NIRCam, EAZY, config


def nadams_jaguar_path(version, survey, is_half = True, fits_cat_dir = config["DEFAULT"]["GALFIND_DATA"]):
...
def main():
    ...
    cat = Catalogue.from_fits_cat(fits_cat_path, version, instrument_names, cat_creator, survey, SED_fit_params_arr)
