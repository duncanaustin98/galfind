...
def pipeline(
    ...
    for pc_err in min_flux_pc_errs:
        ...
        for survey in surveys:
            ...
            GSMF_z10_5 = Number_Density_Function.from_single_cat(
                cat, mass_name, mass_bins, [9.5, 11.5], x_origin=pipes_origin
            )
            GSMF_z10_5.plot(x_lims=mass_name)
            GSMF_z12_5 = Number_Density_Function.from_single_cat(
...
if __name__ == "__main__":
    ...
    lowz_zmax_arr = [[2.0, 4.0, 6.0, None]]  # [[4., 6., None]] #[[None]] #
    min_flux_pc_errs = [10]
