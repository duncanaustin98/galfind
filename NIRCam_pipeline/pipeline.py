...
def pipeline(surveys, version, instruments, aper_diams, min_flux_pc_errs, forced_phot_band, \
        excl_bands, SED_fit_params_arr, cat_type = "loc_depth", select_by = None):
...
if __name__ == "__main__":
    ...
    min_flux_pc_errs = [10]
    forced_phot_band = ["F277W", "F444W"] # "F356W", 
    select_by = None
    ...
    for survey in surveys:
        ...
        excl_bands, SED_fit_params_arr, cat_type = cat_type, select_by = select_by)
