...
from galfind.properties import MUV_Calculator, Redshift_Extractor
from galfind.sed_fitting import EAZY, Bagpipes
...
def main():
    ...
    five_sigma_f444w = Band_SNR_Selector(
        test_aper_diams[0], "F444W", "detect", 5.0
    )
    ...
    pipes_fitter = Bagpipes(
        {
            ...
            "z_calculator": Redshift_Extractor(
                test_aper_diams[0],
