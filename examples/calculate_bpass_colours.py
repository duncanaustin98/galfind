...
if __name__ == "__main__":
    ...
    plt.savefig(
        f"/nvme/scratch/work/austind/EPOCHS_I_plots/{colour_x_name}_vs_{colour_y_name}_z{str(redshifts)}_Z{str(metallicities)}_{alpha_enhancement}.png"
    )
