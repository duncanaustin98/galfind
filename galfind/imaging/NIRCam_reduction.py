...
from ..utils.decorators import run_in_self_dir, log_time
...
class Raw_JWST_Data:
    ...
    def download(
        ...
        Executes curl shell scripts generated by MAST query to download raw data.
        """
    ...
    def make_asn(
        ...
        hdr_cols : `list` of `str`, optional
            FITS header columns to track. Default includes RA, DEC, FILTER, etc.
    ...
    def run_stage2(
        ...
        Applies image-level corrections (flat-field, photometry, WCS) with optional
