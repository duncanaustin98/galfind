...
class Simulated_Catalogue(Catalogue_Base):
    ...
    def __init__(self, gals, cat_path, survey_name, cat_creator, sim, codes = [], version = ''):
        self.sim = sim
    ...
    def from_fits_cat(cls, fits_cat_path, instrument, cat_creator, code_names, low_z_runs, survey, templates = "fsps_larson", data = None, mask = True):
        ...
        gals = np.array([Simulated_Galaxy.from_fits_cat(fits_cat[fits_cat[cat_creator.ID_label] == ID], instrument, cat_creator, [], []) \
