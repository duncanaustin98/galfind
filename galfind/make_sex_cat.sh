...
sex ${FORCED_PHOT_IMAGE_PATH}'['${FORCED_PHOT_EXT}']' ${INPUT_IMAGE_PATH}'['${INPUT_IMAGE_EXT}']' -c ${CONFIG_DIR}/nircam.sex -WEIGHT_TYPE ${WEIGHT_TYPE} -PIXEL_SCALE ${PIXEL_SCALE} -WEIGHT_IMAGE ${FORCED_PHOT_WEIGHT_PATH}'['${FORCED_PHOT_WEIGHT_EXT}']',${INPUT_WEIGHT_PATH}'['${INPUT_WEIGHT_EXT}']' \
