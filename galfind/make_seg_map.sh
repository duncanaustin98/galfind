...
# run sextractor
sex ${INPUT_IMAGE_PATH}'['${INPUT_IMAGE_EXT}']' -c ${CONFIG_DIR}/nircam.sex -WEIGHT_TYPE $INPUT_WEIGHT_TYPE -PIXEL_SCALE ${PIXEL_SCALE} -WEIGHT_IMAGE ${INPUT_IMAGE_PATH}'['${INPUT_WEIGHT_EXT}']' \
